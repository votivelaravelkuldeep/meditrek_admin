...
const DoctorAnaReport = () => {
  ...
  const fetchManageUserDetails = async () => {
    try {
      ...
      const response = await axios.get(`${API_URL}/doctors_analytical_report?action=get_users_analytical_report`);
  ...
  return (
    <>
      ...
      <Typography style={{ marginTop: '15px', marginBottom: '30px' }} variant="h4" gutterBottom>
        <span style={{ color: '#4D6A98', textAlign: 'center' }}>Dashboard</span> / Doctor Analytical Report
      </Typography>
      ...
      <Typography
        ...
        gutterBottom
      >
        2025 Monthly Analytical Reports of Doctors
      </Typography>
      ...
      <Grid container spacing={gridSpacing}>
        ...
        <Typography className="" style={{ margin: ' 40px auto 0px', color: '#000' }} variant="h4" gutterBottom>
          2025 Yearly Analytical Reports of Doctors
        </Typography>
...
export default DoctorAnaReport;
